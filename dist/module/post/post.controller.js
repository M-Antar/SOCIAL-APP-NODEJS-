...
PostRouter.delete("/:id", (0, authintication_middlewear_1.isAuth)(), post_service_1.default.deletePost);
PostRouter.patch("/:id/freeze", (0, authintication_middlewear_1.isAuth)(), post_service_1.default.freezePost);
